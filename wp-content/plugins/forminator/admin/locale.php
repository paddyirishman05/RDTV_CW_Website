...
"The Stripe Subscription Add-ons is required to use this feature. Install it from the Add-ons page." => array( null, __("The Stripe Subscription Add-ons is required to use this feature. Install it from the Add-ons page.", "forminator" ), ), // src/form/components/fields/stripe/addon-required.js:14
"The Stripe Subscription Add-on is required to use this feature. Upgrade to Pro to install the add-on." => array( null, __("The Stripe Subscription Add-on is required to use this feature. Upgrade to Pro to install the add-on.", "forminator" ), ), // src/form/components/fields/stripe/addon-required.js:17
"Get the Add-on" => array( null, __("Get the Add-on", "forminator" ), ), // src/form/components/fields/stripe/addon-required.js:54
...
"Subscription {{span}}Pro{{/span}}" => array( null, __("Subscription {{span}}Pro{{/span}}", "forminator" ), ), // src/form/components/fields/stripe/plan-setup.js:32
"Plan name" => array( null, __("Plan name", "forminator" ), ), // src/form/components/fields/stripe/plan-setup.js:48
"This will be displayed on the submissions as well as the Stripe dashboard." => array( null, __("This will be displayed on the submissions as well as the Stripe dashboard.", "forminator" ), ), // src/form/components/fields/stripe/plan-setup.js:50
"Plan Name is required." => array( null, __("Plan Name is required.", "forminator" ), ), // src/form/components/fields/stripe/plan-setup.js:56
"Payment type" => array( null, __("Payment type", "forminator" ), ), // src/form/components/fields/stripe/plan-setup.js:68
...
"Repeater" => array( null, __("Repeater", "forminator" ), ), // src/form/components/modals/settings.js:660
"Calculations" => array( null, __("Calculations", "forminator" ), ), // src/form/components/modals/settings.js:680
"Customize" => array( null, __("Customize", "forminator" ), ), // src/form/components/modals/settings.js:710
"Visibility" => array( null, __("Visibility", "forminator" ), ), // src/form/components/modals/settings.js:720
