	...
	if (sac_get_current_screen_id() === 'settings_page_simple_ajax_chat') {
		...
		if (!sac_check_date_expired() && !sac_dismiss_notice_check()) {
			...
			<div class="notice notice-success">
				<p>
					<strong><?php esc_html_e('Plugin Sale:', 'simple-ajax-chat'); ?></strong> 
					<?php esc_html_e('Save 20% on any of our', 'simple-ajax-chat'); ?> 
					...
					<?php esc_html_e('Apply code', 'simple-ajax-chat'); ?> <code>PLANET2023</code> <?php esc_html_e('at checkout. Sale ends 9/9/23.', 'simple-ajax-chat'); ?> 
...
function sac_dismiss_notice_link() {
	...
	echo '<a class="sac-dismiss-notice" href="'. esc_url($href) .'">'. esc_html($label) .'</a>';
	
}

function sac_check_date_expired() {
	
	$expires = apply_filters('sac_check_date_expired', '2023-09-09');
