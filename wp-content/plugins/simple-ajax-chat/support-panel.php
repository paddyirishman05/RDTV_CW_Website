...
function simple_ajax_chat_wp_resources() {
	...
	$title2 = esc_html__('Plugin Planet: Pro WordPress Plugins', 'simple-ajax-chat');
	$title3 = esc_html__('Donate via PayPal, credit card, or cryptocurrency', 'simple-ajax-chat');
	...
	<div id="project-wrap">
		...
		<div class="project-blurb">
			<p><strong><?php esc_html_e('Please Donate', 'simple-ajax-chat'); ?></strong></p>
			<p><?php echo $donate; ?></p>
			<ul>
				<li><a target="_blank" rel="noopener noreferrer" href="<?php echo $url3; ?>" title="<?php echo $title3; ?>"><?php esc_html_e('Make a donation&nbsp;&raquo;', 'simple-ajax-chat'); ?></a></li>
			</ul>
		</div>
	</div>
