...
--> 
            <span class="game-custom-fields">
                ...
                <?php 
                    // get raw date
                    $gameDate = get_field('game_date', false, false);
                    // make date object
                    $gameDate = new DateTime($gameDate);
                ?>

                <span class="custom-date">
                    <strong>Date:</strong> <?php echo $gameDate->format('jS F o'); ?>
                </span>
                <br/>
                <span class="custom-details">
                    <strong>Event:</strong> <?php echo get_post_meta($post->ID, 'game_event', true); ?>
                    <br/>
                    <strong>Venue:</strong> <?php echo get_post_meta($post->ID, 'game_venue', true); ?>
                </span>
            </span>
